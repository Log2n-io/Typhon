...
/// </remarks>
[TestFixture]
[Ignore("#771 — a plain open-and-close of a healthy database leaves it Unopenable (WAL-04 Fatal + SEG-02). These tests "
    + "ARE the reproducer; they stay written and stay red-by-ignore rather than being deleted, because the question they "
    + "ask is G3's precondition.")]
