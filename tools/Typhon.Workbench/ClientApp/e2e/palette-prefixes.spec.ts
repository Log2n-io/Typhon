...
test.describe('AC1.3 — command palette prefix routing', () => {
  ...
  // "open" matches every Open-* command available in an open-database session. The count was 5 and unverified: this
  // spec's own setup had been failing at the open step (a 0-byte demo.typhon blocked the bundle path), so nothing here
  // ever ran. With the seed fixed and "Open Trace…" removed (#621), the real figure is 7.
