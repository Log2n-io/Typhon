...
import type { ExecutionInspectorFocus } from './useExecutionInspectorStore';
 ...
 */
export function useExecutions(focus: ExecutionInspectorFocus | null, pageSize: number = 200): ExecutionsResult {
