...
- **`DirtyBitmap`** ([dirty](https://github.com/Log2n-io/Typhon/blob/main/src/Typhon.Engine/Ecs/internals/DirtyBitmap.cs)) — track which entities have been mutated this tick; consumed by view-system delta computation ([09-querying](09-querying.md)).
