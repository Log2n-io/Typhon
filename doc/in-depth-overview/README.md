...
| **`CommitDiscipline`** | Per-transaction escalation for `SingleVersion` components: `TickFence` (default) or `Commit` (atomic, zero-loss, O(1) rollback) | [06-ecs](06-ecs.md), [11-durability](11-durability.md) |
