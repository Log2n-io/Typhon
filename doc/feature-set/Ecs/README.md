...
| &nbsp;&nbsp;↳ [Commit Discipline](storage-modes/storage-mode-committed.md) | Zero-loss, atomic commits on the `SingleVersion` layout — without paying for a `Versioned` revision chain | ✅ Implemented | 🟣 Advanced |
