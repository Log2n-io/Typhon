...
- **Honest watermark ordering always holds** — `CheckpointLSN ≤ DurableLsn ≤ LastPublishedLsn ≤ LastAppendedLsn`, continuously, not just at the moments you happen to check.
