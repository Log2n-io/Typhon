...
description: 'The complete, generated list of every Typhon telemetry gate flag — config key, default, and what it enables (224 flags). Generated from TelemetryConfig.cs.'
---

# Telemetry Flags Reference

> **224 flags.** GENERATED by scripts/gen-telemetry-reference.py from TelemetryConfig.cs — do not hand-edit.
...
```jsonc
// GENERATED by scripts/gen-telemetry-reference.py from TelemetryConfig.cs — do not hand-edit.
