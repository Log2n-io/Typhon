...
description: 'The complete, generated list of every Typhon telemetry gate flag — config key, default, and what it enables (227 flags). Generated from telemetry-flags.jsonc.'
---

# Telemetry Flags Reference

> **227 flags.** GENERATED by scripts/gen-telemetry-reference.py from telemetry-flags.jsonc — do not hand-edit.
    ...
    "Profiler": {
      ...
      "Spatial": {
        ...
        "ClusterMigration": {
          ...
          "Repair": {
            // Combined gate for the Spatial:ClusterMigration:Repair span (kind 64: one admitted repair unit, with its cell and degradation).
            "Enabled": false,
          },
          "Relocation": {
            // Combined gate for the Spatial:ClusterMigration:Relocation instant (kind 65: the per-tick throttle outcome split).
            "Enabled": false,
          },
          "ArchetypeTelemetry": {
            // Combined gate for the Spatial:ClusterMigration:ArchetypeTelemetry instant (kind 66: the per-archetype per-tick counter snapshot the Workbench Spatial panel reads).
            "Enabled": false,
          },
        },
        "TierIndex": {
...
| `Typhon:Profiler:Spatial:ClusterMigration:Repair:Enabled` | `false` | Combined gate for the Spatial:ClusterMigration:Repair span (kind 64: one admitted repair unit, with its cell and degradation). |
| `Typhon:Profiler:Spatial:ClusterMigration:Relocation:Enabled` | `false` | Combined gate for the Spatial:ClusterMigration:Relocation instant (kind 65: the per-tick throttle outcome split). |
| `Typhon:Profiler:Spatial:ClusterMigration:ArchetypeTelemetry:Enabled` | `false` | Combined gate for the Spatial:ClusterMigration:ArchetypeTelemetry instant (kind 66: the per-archetype per-tick counter snapshot the Workbench Spatial panel reads). |
