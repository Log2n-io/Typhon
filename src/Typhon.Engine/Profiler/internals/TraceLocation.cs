...
/// </remarks>
internal static class TraceLocation
{
    /// <summary>Subdirectory of the database bundle holding its profiling captures.</summary>
    internal const string ProfilingsDirectoryName = "profilings";

    /// <summary>Extension of a capture file.</summary>
    internal const string TraceExtension = ".typhon-trace";
    ...
    /// </summary>
    internal const string SidecarSearchPattern = "*" + TraceExtension + Typhon.Profiler.TraceFileCacheConstants.CacheFileExtension;
    ...
    internal static string ProfilingsDirectoryOf(string bundleDirectory)
    {
    ...
    internal static string NewCapturePath(string bundleDirectory, DateTime startedUtc = default)
    {
    ...
    /// </summary>
    internal static string SidecarOf(string capturePath)
    {
    ...
    /// </summary>
    internal static string CaptureOfSidecar(string sidecarPath)
    {
    ...
    /// </remarks>
    internal static bool IsCapture(string path) =>
        path != null
