...
{
    // ref byte (not byte*): a managed pointer into the pinned page — GC-safe, no unsafe field. This type wraps it in the safe ref/Span accessors below.
    private readonly ref byte _addr;

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal PageAccessor(byte* addr) => _addr = ref Unsafe.AsRef<byte>(addr);
    ...
    public byte* Address
    {
        // TODO(cascade): leaf still byte* (public escape hatch consumed by InitHeader/ChunkAccessor pointer arithmetic).
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get => (byte*)Unsafe.AsPointer(ref _addr);
    }
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get => ref Unsafe.As<byte, PageBaseHeader>(ref _addr);
    }
    ...
    public ref T StructAt<T>(int byteOffset) where T : unmanaged
        => ref Unsafe.As<byte, T>(ref Unsafe.Add(ref _addr, byteOffset));
    ...
    public Span<T> Metadata<T>() where T : unmanaged
        => MemoryMarshal.CreateSpan(ref Unsafe.As<byte, T>(ref Unsafe.Add(ref _addr, PagedMMF.PageBaseHeaderSize)), PagedMMF.PageMetadataSize / Unsafe.SizeOf<T>());
    ...
    public ReadOnlySpan<T> MetadataReadOnly<T>() where T : unmanaged
        => MemoryMarshal.CreateReadOnlySpan(ref Unsafe.As<byte, T>(ref Unsafe.Add(ref _addr, PagedMMF.PageBaseHeaderSize)), PagedMMF.PageMetadataSize / Unsafe.SizeOf<T>());
    ...
    public Span<T> Metadata<T>(int byteOffset, int count) where T : unmanaged
        => MemoryMarshal.CreateSpan(ref Unsafe.As<byte, T>(ref Unsafe.Add(ref _addr, PagedMMF.PageBaseHeaderSize + byteOffset)), count);
    ...
    public ReadOnlySpan<T> MetadataReadOnly<T>(int byteOffset, int count) where T : unmanaged
        => MemoryMarshal.CreateReadOnlySpan(ref Unsafe.As<byte, T>(ref Unsafe.Add(ref _addr, PagedMMF.PageBaseHeaderSize + byteOffset)), count);
    ...
    public Span<T> RawData<T>() where T : unmanaged
        => MemoryMarshal.CreateSpan(ref Unsafe.As<byte, T>(ref Unsafe.Add(ref _addr, PagedMMF.PageHeaderSize)), PagedMMF.PageRawDataSize / Unsafe.SizeOf<T>());
    ...
    public ReadOnlySpan<T> RawDataReadOnly<T>() where T : unmanaged
        => MemoryMarshal.CreateReadOnlySpan(ref Unsafe.As<byte, T>(ref Unsafe.Add(ref _addr, PagedMMF.PageHeaderSize)), PagedMMF.PageRawDataSize / Unsafe.SizeOf<T>());
    ...
    public Span<T> RawData<T>(int byteOffset, int count) where T : unmanaged
        => MemoryMarshal.CreateSpan(ref Unsafe.As<byte, T>(ref Unsafe.Add(ref _addr, PagedMMF.PageHeaderSize + byteOffset)), count);
    ...
    public ReadOnlySpan<T> RawDataReadOnly<T>(int byteOffset, int count) where T : unmanaged
        => MemoryMarshal.CreateReadOnlySpan(ref Unsafe.As<byte, T>(ref Unsafe.Add(ref _addr, PagedMMF.PageHeaderSize + byteOffset)), count);
}
