...
/// <remarks>
/// <para>
/// This is a knob on the durability axis (see <c>DurabilityDiscipline</c> and ADR-005), not the storage axis: it changes *when* values become durable, never the
...
/// atomicity, lifecycle records (Spawn / Destroy / SetEnabledBits) and <c>DurabilityDiscipline.Commit</c> writes are likewise untouched.
/// </para>
/// <para>
...
public enum ClusterDurability : byte
{
    ...
    /// <c>DurabilityDiscipline.Commit</c> or <see cref="StorageMode.Versioned"/> for that, both of which keep working normally alongside this setting.
    /// </para>
    /// <para>
